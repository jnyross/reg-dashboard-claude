...
function mockMiniMaxResponse(content) {
...
describe("analyzeItem", () => {
    it("parses a relevant LLM response correctly", async () => {
        ...
        const result = await (0, analyzer_1.analyzeItem)(testItem, "test-api-key");
...
describe("analyzeItems", () => {
    it("filters out irrelevant and failed items", async () => {
        ...
        const results = await (0, analyzer_1.analyzeItems)(items, "test-key", 2);
    ...
    it("reports progress", async () => {
        ...
        const progress = [];
        await (0, analyzer_1.analyzeItems)(items, "test-key", 2, (completed, total) => {
